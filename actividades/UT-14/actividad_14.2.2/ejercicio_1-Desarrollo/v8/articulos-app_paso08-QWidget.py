...
'''
Para que el ide reconozca los import de los subdirectorios es necesario marcar el directorio v8 como raiz:
...
class ArticulosApp(QWidget):
    ...
    def config_ui(self) -> None:
        ...
        self.panel_baja = UIBajaArticulo(self.panel_central, self.articulosDao)
        self.panel_edicion = UIEditaArticulo(self.panel_central, self.articulosDao)
        self.panel_listado = UIListadoArticulos(self.panel_central, self.articulosDao)
    ...
    def opcion_listado(self) -> None:
        ...
        self.panel_listado.cargar_datos()
