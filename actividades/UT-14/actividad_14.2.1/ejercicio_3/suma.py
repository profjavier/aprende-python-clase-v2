...
Modifique el ejercicio anterior para que el mensaje lo muestre en un QLabel.
"""
...
class Suma(QWidget):
    ...
    def config_ui(self):
        ...
        self.lbl_messages.setGeometry(20, 270, 360,25)
    ...
    def sumar(self):
        try:
            ...
            self.lbl_messages.clear()
        except Exception:
            # QMessageBox.warning(self, "Error", "Numeros incorrectos")
            self.lbl_messages.setText("Los numeros no son correctos")
